...
.. note::
   ...
   The :py:func:`redisent.helpers.RedisentHelper.wrapped_redis` property will point to either the blocking context manager :py:meth:`redisent.helpers.RedisentHelper.wrapped_redis_blocking`.
